...
export default function NoaVideoPage() {
  ...
  return (
    <div className="page-container">
      ...
      {hasError && (
        <div style={{ padding: '16px', background: 'var(--status-rejected-bg)', borderRadius: 10, color: 'var(--status-rejected-text)', marginBottom: 20, fontSize: 14 }}>
      ...
      {activeTab === 'prompt' && (
        isLoading ? (
          ...
          <EmptyState
            icon={<PenLine size={48} color="var(--text-secondary)" strokeWidth={1.5} />}
      ...
      {activeTab === 'video' && (
        isLoading ? (
          ...
          <EmptyState
            icon={<Film size={48} color="var(--text-secondary)" strokeWidth={1.5} />}
